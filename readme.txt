...
Have you previously been on Blogger and using [Intense Debate](http://www.intensedebate.com) as your Blogger Commenting system? Now when you are on move from Wordpress to Blogger you might be thinking of losing all your comments right?

This is where IntenseDebate XML Importer saves you! Although Intense Debate [had a plugin to do this](http://blog.intensedebate.com/2010/02/09/blogger-to-wordpress/) they have disabled the plugin due to some system maintenance...

My bad luck was that I shifted my Blogger blog to WP the time when ID disabled their existing plugin! But I really didn want to lose my comments...

So I looked into their plugin code and their export XML file and wrote this plugin to import all the comments from the backup XML to your WP Blog! Have a look at the Installation page to get more idea! 
